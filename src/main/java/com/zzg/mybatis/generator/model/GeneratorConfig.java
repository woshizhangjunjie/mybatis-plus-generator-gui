...
public class GeneratorConfig {
	...
	public String getParentPackageTargetFolder() {
		return parentPackageTargetFolder;
	}

	public void setParentPackageTargetFolder(String parentPackageTargetFolder) {
		this.parentPackageTargetFolder = parentPackageTargetFolder;
	}
